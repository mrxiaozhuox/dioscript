...
use crate::{
    ast::{CalculateMark, DioAstStatement, DioscriptAst},
    ...
    pub fn execute_scope(
        ...
        for v in statements {
            ...
            match v {
                ...
                crate::ast::DioAstStatement::LoopStatement(data) => {
                    let sub_scope = self.scope.insert(
                        Node::new(ScopeType::Block),
                        id_tree::InsertBehavior::UnderNode(current_scope),
                    )?;
                    ...
                    match execute_type {
                        crate::ast::LoopExecuteType::Conditional(cond) => loop {
                            let cond = cond.clone();
                        ...
                        crate::ast::LoopExecuteType::Iter { mut iter, var } => {
